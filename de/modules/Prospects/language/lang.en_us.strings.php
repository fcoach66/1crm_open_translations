...
LBL_SAVE_MODULE: Save Target
MSG_SHOW_DUPLICATES:
	Creating this target may potentially create a duplicate target. You may either click on Save to continue creating this new target with the previously entered data or you may click Cancel.
MSG_DUPLICATE:
	Creating this target may potentially create a duplicate target. You may either select a target from the list below or you may click on Save to continue creating a new target with the previously entered data.
...
LBL_TRACKER_KEY: Campaign Tracker Key
LBL_LEAD_ID: Lead Id
...
LBL_WARN_INVALID_EMAIL: This Target's email is marked as invalid. Continue with email composition?
LBL_WARN_EMAIL_OPTOUT: This Target has 'Email Opt-out' flag set. Continue with email composition?
LBL_SUBS_BUTTON_TITLE: Manage Subscriptions
LBL_SUBS_BUTTON_LABEL: " Manage Subscriptions "
LBL_ADDITIONAL_DETAILS: Target Details
LBL_CONVERT_TO_TARGET_LIST: Convert to Target List
CONVERT_TO_PLIST: Convert to Target List
LBL_RECORDS_LIMIT: Targets Limit Reached
