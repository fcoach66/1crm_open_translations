...
LNK_NEW_EMAIL_MARKETING: Create Email Marketing
LNK_EMAIL_MARKETING_LIST: Email Marketing
...
ERR_NO_EMAIL_MARKETING:
	There must be atleast one active Email Marketing message associated with the campaign.
...
ERR_NO_MAILBOX:
	Following marketing message do not have a mailbox associated with them.<BR>Please correct that before proceeding.
ERR_NO_QCAMPAIGN_MAILBOX: Please select a mailbox
ERR_NO_QCAMPAIGN_TEMPLATE: Please select a template
...
LBL_SCHED_SETUP_WIZARD: Scheduler Setup
LBL_DIAGNOSTIC_WIZARD: Diagnostics
LBL_ALREADY_SUBSCRIBED_HEADER: Subscribed to Newsletters
LBL_UNSUBSCRIBED_HEADER: Available Newsletters
LBL_OPTED_OUT_HEADER: Opted-out of Newsletters
...
LBL_WIZARD_SUBSCRIPTION_MESSAGE:
	Each newsletter must have three target lists (Subscription, Unsubscription, and Test). You can assign an existing target list. If not, an empty target list will be created when you save the newsletter.
LBL_WIZARD_TARGET_MESSAGE1:
	Select or create a target list for use with your campaign.  This list will be used while sending emails with your marketing messages.
LBL_WIZARD_TARGET_MESSAGE2: Or create a new one using the form below
LBL_WIZARD_TRACKER_MESSAGE:
	Define a tracker URL here to use with this campaign. You must enter both the name and the URL to create the tracker.
LBL_WIZARD_MARKETING_MESSAGE:
	Fill out the form below to create an email instance for your newsletter.  This will allow you to specify the information regarding when and how your newsletter should be sent out.
LBL_WIZARD_SENDMAIL_MESSAGE:
	This is the last step in the process.  Choose whether you wish to send out a test, schedule your newsletter to be sent, or simply to save your work and go to summary.
...
LBL_WIZARD_FIRST_STEP_MESSAGE:
	"             You cannot go back any further, you are already at the first step."
...
LBL_SUBSCRIPTION_TARGET_WIZARD_DESC:
	This will define the target list of type Subscription for this campaign.<br>  This target list will be used to send out emails for this campaign.  <br>If you do not have a list ready, an empty list will be created for you.
LBL_UNSUBSCRIPTION_TARGET_WIZARD_DESC:
	This will define the target list of type Unsubscription for this campaign.  <br>This target list will contain names of people who have opted out of your campaign and should not be contacted through email.  <br>If you do not have a list ready, an empty list will be created for you.
LBL_TEST_TARGET_WIZARD_DESC:
	This will define the target list of type Test for this campaign.  <br>This target list will be used to send out test emails for this campaign.  <br>If you do not have a list ready, an empty list will be created for you.
...
LBL_CONFIRM_SEND_SAVE:
	You are about to leave and proceed to the Send Campaign Email page.  Do you wish to save and continue?
...
LBL_NO_TARGET_ENTRIES_WARNING:
	You cannot send a marketing email until your target list has at least one entry.  You can populate your list after finishing.
LBL_NO_TARGETS_WARNING:
	You cannot send a marketing email until your campaign has at least one target list.
...
LBL_MAILBOX_CHECK_WIZ_GOOD:
	Active Mailbox(es) with bounce handling detected.  You do not need to create a new one, but you can still do so below.
LBL_MAILBOX_CHECK_WIZ_BAD:
	No active mailboxes with bounce handling were detected, please create a new one below.
...
LBL_EMAIL_SETUP_DESC:
	Fill out the form below to modify your System Settings so that Campaign Emails can be sent out.
...
LBL_MAILBOX_CHECK1_BAD: No Active Mailboxes with bounce handling detected.
LBL_MAILBOX_CHECK2_GOOD: " E-mail Settings have been configured"
LBL_MAILBOX_CHECK2_BAD:
	Please configure your system email address.  E-mail Settings have not been configured.
...
LBL_MARKETING_CHECK1_BAD:
	No Email marketing components detected, you will need to create one to mail out a campaign.
LBL_MARKETING_CHECK2_GOOD: Target lists detected.
LBL_MARKETING_CHECK2_BAD:
	No target lists detected, you will need to create one from desired campaign screen.
...
LBL_WEB_TO_LEAD_FORM_TITLE: Create Lead Form
LBL_WEB_TO_LEAD_FORM_TITLE1: Select fields
LBL_WEB_TO_LEAD_FORM_TITLE2: Form properties
...
LBL_DOWNLOAD_TEXT_WEB_TO_LEAD_FORM:
	You may use the link below to download your web-to-lead form. This will open in a new window, or you can right-click the link to save the target web page.
...
LBL_LEAVE_ON_SERVER: Leave mail on server
LBL_HOST: Host
LBL_USERNAME: Username
LBL_PROTOCOL: Protocol
LBL_IMAP_FOLDER: IMAP folder
LBL_USE_SSL: Use SSL
LBL_MANAGE_LISTS_CAMPAIGNS_SUFFIX: " ({N} campaigns)"
LBL_SECURITYGROUPS_SUBPANEL_TITLE: Teams
LBL_DEFINE_LEAD_DUP_ERROR: Error message for duplicate lead
LBL_DEFAULT_LEAD_DUP_ERROR: You are already registered
LBL_ADDITIONAL_DETAILS: Account Details
LBL_QC_MAILBOX: Campaign Mailbox
LBL_QC_TEMPLATE: Email Template
LBL_RUN_QCAMPAIGN_BUTTON_LABEL: Run Campaign
LBL_LAYOUT_STANDARD: Details
LBL_LAYOUT_STATUS: Status
LBL_LAYOUT_ROI: ROI
