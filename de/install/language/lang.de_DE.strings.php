...
ERR_UW_NO_UPDATE_RECORD: Es konnte keine bestehende Installation gefunden werden.
ERROR_FLAVOR_INCOMPATIBLE: Die hochgeladene Datei ist nicht mit dieser Version von 1CRM kompatibel
ERROR_LICENSE_EXPIRED: "Fehler : Die Lizenz ist abgelaufen"
ERROR_LICENSE_EXPIRED2: . "Tag (e). Bitte prüfen Sie auf der Verwaltungsseite die Lizenz und geben ggf. die Neue ein. <a href='index.php?action=LicenseSettings&module=Administration'>\"Lizenz\"</a>."
ERROR_MANIFEST_TYPE: Die Manifest-Datei ist nicht im richtigen Format.
ERROR_PACKAGE_TYPE: Die Manifest-Datei ist nicht im richtigen Format gepackt.
ERROR_VALIDATION_EXPIRED: "Fehler: Ihr Aktivierungsschlüssel ist abgelaufen"
ERROR_VALIDATION_EXPIRED2: . "Tag(e) Bitte besuchen Sie  <a href='index.php?action=LicenseSettings&module=Administration'>\"Lizenz\"</a> auf der Verwaltungsseite , um Ihre neuen Validierungsschlüssel eingeben. Der Schluessel gilt bis 30 Tage nach Ablauf der Lizenz."
ERROR_VERSION_INCOMPATIBLE: Die hochgeladene Datei ist nicht mit dieser Version von 1CRM kompatibel
LBL_BACK: Zurück
address_format_names_dom
	Britain: Großbritannien/USA/Canada
	France: Europa 1  (Firma nach Person, FR)
	Germany: Europa 2 (Firma vor der Person, DE)
	Japan: Japan
	Switzerland: Schweiz
DEFAULT_CHARSET: UTF-8
ERR_ADMIN_PASS_BLANK: Das Administrator-Passwort darf nicht leer sein .
ERR_CHECKSYS_CALL_TIME:
	 Der "Alow Call Time Pass Reference" Parameter in der php.ini soll auf "Aus" gesetzt sein. Jetzt steht er auf "On" 
ERR_CHECKSYS_CURL:
	Nicht gefunden: SCHEDULER / CURL, 1CRM wird aber ohne einer Reihe von Features arbeiten.
ERR_CHECKSYS_IMAP:
    Nicht gefunden: Die IMAP -Bibliotheken für den Empfang von E-Mails und Kampagnen wurden nicht gefunden. Der Email Empfang wird nicht einwandfrei funktionieren.
ERR_CHECKSYS_MSSQL_MQGPC:
    Der MYSQL Parameter "Magic Quotes GPC" kann nicht gesetzt werden. Er sollte bei Verwendung von MS SQL Server auf "on" stehen.
ERR_CHECKSYS_MBSTRING:
	Nicht gefunden: 1CRM kann nicht mit Multi-Byte-Zeichen umgehen. Dies wird beim Empfang von E-Mails , deren Zeichensatz sich von UTF-8 unterscheidet auswirken.
ERR_CHECKSYS_MEM_LIMIT_1: "$memory_limit (weiter zu "
ERR_CHECKSYS_MEM_LIMIT_2: M in der php.ini-Datei)
ERR_CHECKSYS_MYSQL_VERSION: MYSQL ab Version 5.x.x - Gefunden
ERR_CHECKSYS_NO_SESSIONS:
Fehler beim Schreiben und Lesen der Session-Variablen . Die Installation kann nicht durchgeführt werden.
ERR_CHECKSYS_NOT_VALID_DIR: Ungültige Verzeichnis
ERR_CHECKSYS_NOT_WRITABLE: Fehler: Keine Schreibberechtigung
ERR_CHECKSYS_PHP_INVALID_VER: Die installierte PHP -Version ist ungültig: 
ERR_CHECKSYS_PHP_JSON: nicht gefunden: Das PHP - JSON -Modul zur Leistungsoptimierung.
ERR_CHECKSYS_PHP_JSON_VERSION:
    Nur die Version 1.1.1 von PHP - JSON wird nun von 1CRM unterstützt.  Bitte mahen sie das Update auf die Version 1.1.1. Der PHP-Code und AJAX werden mit dem Modul beschleunigt.
ERR_CHECKSYS_PHP_UNSUPPORTED: Die akktuell auf dem Server installlierte Version von PHP wird nicht unterstützt 
ERR_CHECKSYS_SAFE_MODE: PHP Save Mode ist aktiviert. 1CRM erfordert das er in der  php.ini deaktiviert ist.
ERR_CHECKSYS_ZLIB: nicht gefunden: Die zlib-Kompression ist auf dem Server nicht aktiviert. Bitte installieren oder reaktivieren.
ERR_CHECKSYS_ZIP: Nicht gefunden: Die ZIP-Erweiterung ist nicht konfiguriert aber erforderlich,
ERR_DB_ADMIN: "Der Benutzername des Administrators der Datenbank und / oder sein Passwort sind ungültig"
ERR_DB_EXISTS_NOT: Die ausgewählte Datenbank ist nicht vorhanden.
ERR_DB_EXISTS_WITH_CONFIG:
    Es ist eine installierte Datenbank vorhanden und sie enthält Konfigurationsdaten. Um eine Installation mit dieser Datenbank zu starten (und sie zu überschreiben), führen Sie Setup erneut , und wählen Sie "1CRM Tabellen Löschen und neu erstellen". Um ein Update durchzuführen, verwenden Sie bitte die Aktualisierungsassistenten in der Verwaltung.
ERR_DB_EXISTS:
    Der Name der Datenbank ist bereits vorhanden - erstellen Sie eine neue Datenbank.
ERR_DB_HOSTNAME: Der Hostname darf nicht leer sein .
ERR_DB_INVALID: Der gewählte Datenbanktyp ist ungültig.
ERR_DB_LOGIN_FAILURE_MYSQL: "Fehler: Der Datebenbank Username oder das Kennwort sind ungültig"
ERR_DB_LOGIN_FAILURE_MSSQL:
Der Datebenbank Username oder das Kennwort sind ungültig
ERR_DB_MYSQL_VERSION1: Die MySQL Version
ERR_DB_MYSQL_VERSION2 "wird nicht unterstützt. Nur MySQL { VERSION } oder höheren Versionen werden unterstützt .. "
ERR_DB_NAME: Der Name der Datenbank darf nicht leer sein.
ERR_DB_NAME2:
Der Name der Datenbank darf keine der Zeichen '\', '/' oder 'enthalten."
ERR_DB_PASSWORD: Die Passwörter stimmen nicht überein.
ERR_DB_PRIV_USER: Bitte den Benutzername des Datenbankadministrators angeben.
ERR_DB_USER_EXISTS: Der gewählte Benutzername ist bereits vorhanden - Bitte wählen sie einen anderene.
ERR_DB_USER: Der Benutzername für 1CRM darf nicht leer sein .
ERR_DBCONF_VALIDATION: Bevor Sie fortfahren korrigieren Sie bitte die folgenden Fehler, 
ERR_ERROR_GENERAL: Der folgende Fehler sind aufgetreten:
ERR_LANG_CANNOT_DELETE_FILE: Die Datei kann nicht gelöscht werden
ERR_LANG_MISSING_FILE: Datei kann nicht gefunden werden
ERR_LANG_NO_LANG_FILE: Keine Sprachdateien im Sprachpaket gefunden
ERR_LANG_UPLOAD_1: Während des Upload ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.
ERR_LANG_UPLOAD_2: Die Sprachpakete müssen im ZIP-FORMAT gepackt sein .
ERR_LANG_UPLOAD_3:
PHP konnte die temporäre Datei nicht in den Update Ordner verschieben.
ERR_LICENSE_MISSING: Bitte geben Sie alle Pflichtfelder ein
ERR_LICENSE_NOT_FOUND: Datei nicht gefunden!
ERR_LOG_DIRECTORY_NOT_EXISTS: Das Log-Verzeichnis ist ungültig .
ERR_LOG_DIRECTORY_NOT_WRITABLE: Das Log-Verzeichnisch hat keine Schreibberechtigungen .
ERR_LOG_DIRECTORY_REQUIRED: Das LOG-Verzeichnis ist erforderlich. Bitte angeben!
ERR_NO_DIRECT_SCRIPT: Fehler; Das Skript kann nicht direkt ausgeführt werden.
ERR_NO_SINGLE_QUOTE: "Die Verwendung einfacher Anführungszeichen (') ist nicht erlaubt. "
ERR_PASSWORD_MISMATCH: Das Administratorpasswort für 1CRM ist nicht korrekt.
ERR_PERFORM_CONFIG_PHP_1: Die Konfigurationsdatei hat keine Schreibrechte.
ERR_PERFORM_CONFIG_PHP_2:
Sie können die Installation fortsetzen indem Sie die Datei config.php manuell erstellen. Sie müssen diese Datei jedoch  <strong>unbedingt </strong> erstelle, bevor sie den nächsten Installationsschritt ausführen.
ERR_PERFORM_CONFIG_PHP_3: Haben Sie vergessen die config.php -Datei zu erstellen ?
ERR_PERFORM_CONFIG_PHP_4:
Warnung: Die Config-Datei kann nicht geschrieben werden. Bitte prüfen Sie ob die Datei existiert.
ERR_PERFORM_HTACCESS_1: "Die Datei kann nicht geschreiben werden"
ERR_PERFORM_HTACCESS_2: " . "
ERR_PERFORM_HTACCESS_3:
Um Ihre Log abzusichern und zu Verhindern, dass sie  über einen Browser gelesen werdenkann, erstellen Sie bitte eine .Htaccess -Datei in thr Dokumenten-Rootverzeichnis mit der Zeile
ERR_SESSION_DIRECTORY_NOT_EXISTS: Das Sessionverzeichnis für PHP ist ungültig oder falsch.
ERR_SESSION_DIRECTORY: Das Verzeichnis für die PHP Sessions hat keine Schreibberechtigung.
ERR_SESSION_PATH: Ein ein Session Path (Pfad) ist erforderlich. Sie können Ihren individuellen angeben.
ERR_SI_NO_CONFIG:
Sie haben die Datei config_si.php nicht ins Dokument-Root Vereichnis installiert oder den Pfad $sugar_config_si in der config.php falsch angegeben.
ERR_SITE_GUID: Bitte geben Sie die richtige Anwendungs-ID an. 
ERR_UPLOAD_MAX_FILESIZE:
	Warning: Ihre PHP Konfiguration muss geändert werden. Verändern sie die maximale Grösse für Uploads auf 10MB oder mehr.
ERR_URL_BLANK: URL darf nicht leer sein.
ERR_UW_NO_UPDATE_RECORD: Folgendes Installationsfile konntenicht gefunden werden_
ERROR_FLAVOR_INCOMPATIBLE: Das Hochgeladene File ist nicht mit dieser Generation von 1CRM kompatibel.
ERROR_LICENSE_EXPIRED: "Fehler: Die Lizenz ist "
ERROR_LICENSE_EXPIRED2:
	" Tage zuvor abgelaufen.   Bitte gehen Sie zur <a href='index.php?action=LicenseSettings&module=Administration'>\"Administration\"</a>  in der Verwaltungsoberfläche um den neuen Lizenzschlüssel einzutragen. Wenn Sie die Lizenz nicht inerhalb der nächsten 30 Tage erneuern  können sie nicht wieder einloggen."
ERROR_MANIFEST_TYPE: Die Manifest Datei muss den Packet Typ speziefizieren.
ERROR_PACKAGE_TYPE: Die Manifest Datei hat einen ungültigen Pakettyp angegeben
ERROR_VALIDATION_EXPIRED: "Error: Ihr Lizenzschlüssel ist "
ERROR_VALIDATION_EXPIRED2:
	" Tage zuvor abgelaufen.   Bitte gehen Sie zur  <a href='index.php?action=LicenseSettings&module=Administration'>\"Lizenz Verwaltung\"</a> in der Verwaltungsoberfläche um den neuen Lizenzschlüssel einzutragen. Wenn Sie die Lizenz nicht inerhalb der nächsten 30 Tage erneuern  können sie nicht wieder einloggen."
ERROR_VERSION_INCOMPATIBLE: Das hochgeladene File ist nicht mit dieser Version von 1CRM kompatibel.
LBL_BACK: Zurück
LBL_CHECKSYS_1:
