...
LBL_SCHEDULE_MESSAGE_EMAILS:
	Please select the campaign messages that you would like to schedule for sending at specified start date and time
LBL_SCHEDULE_BUTTON_TITLE: Send
LBL_SCHEDULE_BUTTON_LABEL: Send
LBL_SCHEDULE_BUTTON_KEY: T
LBL_TEMPLATE_NAME: Template Name
LBL_CAMPAIGN_ID: Campaign ID
LBL_DREEPFEED_DELAY: Delay from Start of Drip-Feed
LBL_DREEPFEED_DELAY_LIST: Drip-Feed Delay
LBL_ENTRIES: Total Recipients
