...
LBL_LIST_FILETYPE: File Type
LBL_SECTION: Section
LBL_MODULE_TITLE_HR: HR Documents: Home
LBL_MODULE_NAME_HR: HR Documents
LNK_HR_EMPLOYEE_RECORDS: Employee Records
LNK_HR_NEW_DOCUMENT: Create HR Document
LNK_HR_DOCUMENT_LIST: HR Documents
LBL_SHOW_PERSONAL_DOCS: Show Personal Documents
LBL_RELATED_TO: Related To
LBL_DOCUMENTS_SUBPANEL_TITLE: Related Documents
LBL_REVISIONS: Revisions
LBL_REV_LIST_REVISION: Revisions
LBL_REV_LIST_ENTERED: Date Created
LBL_REV_LIST_CREATED: Created by
LBL_REV_LIST_LOG: Change Log
LBL_RELATED_DOCUMENTS: Related Documents
LBL_CURRENT_DOC_VERSION: Current Revision
LBL_OPEN_GDOCS: Open in Google Docs
LBL_SECURITYGROUPS_SUBPANEL_TITLE: Teams
LBL_RELATED_USER: Related User
LBL_SHOW_ONLY_GENERIC_DOCS: Show Only Generic HR Docs
