...
LBL_CONVERTLEAD: Convert to Contact
LBL_COUNTRY: Country
...
LBL_DUPLICATE: Possible Duplicate Lead
...
MSG_SHOW_DUPLICATES:
	Creating this lead may potentially create a duplicate lead. You may either click on Save to continue creating this new lead with the previously entered data or you may click Cancel.
...
LBL_ALL_ACTIVE: All Active
LBL_SECURITYGROUPS_SUBPANEL_TITLE: Teams
LBL_REASSIGN_LEADS: Re-assign Leads
LBL_REASSIGN_OBJECTS: Reassign Related Objects
LBL_LEADS_DASHLET: A customizable view into Leads
LBL_EMAIL_LEADS_BUTTON_LABEL: Email Leads
LBL_EVENTS_SUBPANEL_TITLE: Marketing Events
LBL_PARTNER: Partner
LBL_PARTNER_NAME: Partner Name/Code
LBL_EMAIL_MULTI_BUTTON_LABEL: Email Leads
LBL_SAVE_MODULE: Save Lead
...
LBL_WARN_INVALID_EMAIL: This Lead's email is marked as invalid. Continue with email composition?
LBL_WARN_EMAIL_OPTOUT: This Lead has 'Email Opt-out' flag set. Continue with email composition?
LBL_CATEGORY: Category
LBL_TEMPERATURE: Temperature
LBL_DATE_CONVERTED: Date Converted
LBL_SUBS_BUTTON_TITLE: Manage Subscriptions
LBL_SUBS_BUTTON_LABEL: " Manage Subscriptions "
LBL_IMPORT_ERROR:
	Error importing vCard. Please make sure the vCard specifies either last name, full name, or both
LBL_THANKS_FOR_SUBMITTING_LEAD: Thank you
ERR_DUPLICATE: You are already registered
db_primary_address_city: LBL_PRIMARY_ADDRESS_CITY
LBL_ADDITIONAL_DETAILS: Lead Details
LBL_LAST_ACTIVITY: Last Activity Date
LBL_LIST_LAST_ACTIVITY: Last Activity
LBL_WEBSITE: Web Site
LBL_QCAMPAIGN_BUTTON_LABEL: Quick Campaign
QCAMPAIGN: Quick Campaign
MAIL_MERGE: Mail Merge
LBL_SERVER_IS_CURRENTLY_UNAVAILABLE: Server is currently unavailable. Please try again later
CONVERT_TO_PLIST: Convert to Target List
LBL_CONVERT_TO_TARGET_LIST: Convert To Target List
LBL_SKYPE_ID: Skype ID
LBL_RECORDS_LIMIT: Leads Limit Reached
